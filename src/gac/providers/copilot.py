    ...
    def _get_api_key(self) -> str:
        ...
        if not tokens:
            raise AIError.authentication_error(
                ...
                suggestion="Run 'uvx gac auth copilot login' to authenticate.",
            )
        ...
        if not session_token:
            raise AIError.authentication_error(
                ...
                suggestion="Your GitHub account may not have Copilot access, or the OAuth token has been revoked. "
                "Run 'uvx gac auth copilot login' to re-authenticate.",
            )
